...
<div class="container">
    <h1 class="animated bounceInLeft"><div class="btn-default center" style="text-align:center">注册窗口</div></h1>
    <form class="form-horizontal vertical-center" role="form" action="owner_register.action" method="post">
